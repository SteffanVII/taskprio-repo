...
import { useDialogsStore, useDialogsStore_acceptInvitationDialog } from "@/stores/dialogs"
...
const AcceptInvitationDialog = () => {
  ...
  const setAcceptDialogStore = useDialogsStore(state => state.setAcceptInvitationDialog)
  ...
  const {
    ...
    setAcceptDialogStore(null, false)
  })
  ...
  return (
    <Dialog
      open={open}
      onOpenChange={(open) => {
        setAcceptDialogStore(null, open)
      }}
    >
      <DialogContent>
        <DialogHeader>
