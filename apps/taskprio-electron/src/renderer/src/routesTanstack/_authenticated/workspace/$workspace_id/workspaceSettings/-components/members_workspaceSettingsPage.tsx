...
import UserAvatar from "../../../../../../components/others/shared/UserAvatar";
import WorkspaceMemberBadge from "../../../../../../components/others/shared/WorkspaceMemberBadge";
...
export const Members_WorkspaceSettingsPage = () => {
  ...
  const handleInviteMemberOnClick = () => {
    setWorkspaceInvitationDialog(true)
  }
