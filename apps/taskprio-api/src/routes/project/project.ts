        ...
        async (req: IDeactiveProjectMemberRequest, res: Response) => {
            ...
            try {
                ...
                wsConnectionsManager.broadcastToChannel(
                    ...
                    workspaceId,
                    {
                        type: EWebSocketEventType.PROJECT_MEMBER_DEACTIVATED,
                        message: wsMessage
                    },
        ...
        async (req: IReactivateProjectMemberRequest, res: Response) => {
            ...
            try {
                ...
                wsConnectionsManager.broadcastToChannel(
                    ...
                    workspaceId,
                    {
                        type: EWebSocketEventType.PROJECT_MEMBER_REACTIVATED,
                        message: wsMessage
                    },
                    projectMembers.map((member) => member.user_id),
                    [user_id]
